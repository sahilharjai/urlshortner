...
def getASN(host):
    try:
        g = pygeoip.GeoIP('/home/sahil/Desktop/urlshortner/urlshortner/shortner/GeoIPASNum.dat')
...
def feature_extract(url_input):
        ...
        Feature['No_of_dots']=no_of_dots(url_input)
        ...
        return Feature
def feature_extract_1(url_input):
        ...
        print("host",host)
        Feature['avg_token_length'],Feature['token_count'],Feature['largest_token'] = Tokenise(host)
        Feature['avg_domain_token_length'],Feature['domain_token_count'],Feature['largest_domain'] = Tokenise(host)
        Feature['avg_path_token'],Feature['path_token_count'],Feature['largest_path'] = Tokenise(path)
        ...
        #return Feature
        return_obj=[]
        return_obj1=[Feature['token_count'],int(Feature['rank_host']),int(Feature['rank_country']),
        Feature['ASNno'],Feature['sec_sen_word_cnt'],Feature['avg_token_length'],Feature['No_of_dots'],Feature['Length_of_url'],
        Feature['avg_path_token'],Feature['IPaddress_presence'],Feature['Length_of_host'],Feature['safebrowsing'],Feature['avg_domain_token_length'],
        Feature['path_token_count'],Feature['largest_domain'],Feature['domain_token_count'],
        Feature['largest_path'],Feature['largest_token']
        ]
        return_obj.append(return_obj1)
        print(return_obj)
        return return_obj
